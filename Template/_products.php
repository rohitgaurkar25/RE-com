...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./assets/products/1.png" ?>" alt="product" class="img-fluid" style="width: 1500px;height: 250px;">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">Rs499.00</span></td>
                    </tr>
                </table>
                <!---    !product price       -->
